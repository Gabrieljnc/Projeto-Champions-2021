...
def Data_Clean_STD (lista,lista_nova): # Função para tabela standard GAMES - MINUTES - START
    lista = lista[1:4]
    for i in lista:
        lista_nova.append(float(i))
...
url = 'https://fbref.com/en/stathead/player_comparison.cgi?request=1&sum=0&comp_type=spec&dom_lg=1&spec_comps=8&player_id1=c3ee18ef&p1yrfrom=2020-2021&player_id2=7f3b388c&p2yrfrom=2020-2021&player_id3=a3d94a58&p3yrfrom=2020-2021&player_id4=4d224fe8&p4yrfrom=2020-2021&player_id5=86dd77d1&p5yrfrom=2020-2021&player_id6=4aea5077&p6yrfrom=2020-2021&player_id7=72c812f3&p7yrfrom=2020-2021'
...
Teams_Defensors[5] = 'Borussia Mönchengladbach'
...
cur.execute("""INSERT INTO Stats_UCL_DEF (player, team, position_player, games, games_starts, minutes, minutes_90s, tackle, tackle_won, tackle_DEF, tackle_MID, tackle_ATK, blocks, blocks_shot, blocks_pass, interception, cleareance) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)""", 
(Defensors_name[4],Teams_Defensors[4], Position_Players[4], Data_Defensors_std_Format_5[0], Data_Defensors_std_Format_5[1], Data_Defensors_std_Format_5[2], # PLAYER, TEAM, POSITION_PLAYER, GAMES, GAMES_START, MINUTES
Data_Defensors_Format_5[0], Data_Defensors_Format_5[1], Data_Defensors_Format_5[2], Data_Defensors_Format_5[3], # MINUTES_90S, TACKLE, TACKLE WON, TACKLE_DEF
Data_Defensors_Format_5[4], Data_Defensors_Format_5[5], Data_Defensors_Format_5[6], # TACKLE_MID, TACKLE_ATK, BLOCKS
Data_Defensors_Format_5[7], Data_Defensors_Format_5[8], Data_Defensors_Format_5[9], Data_Defensors_Format_5[10])) # BLOCKS_SHOT, BLOCKS_PASS, INTERCEPTIONS, CLEARENCES)) 
